...
def main(TEST_MODE=False):
    ...
    links = read_links() # TODO пока считываем все новости последнего месяца повторно на наличие новых, далее хз как исправить
    for link in links:
        try:
...
if __name__ == "__main__":
    ...
    #from util.csv_workflow import print_csv
