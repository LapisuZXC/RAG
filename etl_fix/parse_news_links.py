...
from util.csv_workflow import get_last_date
...
news_file = "data/raw/last_news_text.csv" # адрес новостей
...
def main():
    ...
    start_date = max(end_date - relativedelta(months=2), get_last_date(news_file))
    required_monthes = generate_month_list(start_date, end_date)
    links = []
